...
public class MyPostsFragment extends Fragment implements ProfilePostAdapter.OnItemClickListener {
    ...
    public static MyPostsFragment newInstance(String userId) {
